...
const SavedJobs = () => {
  ...
  const remove = async (job) => {
    try {
      ...
      setError("Could not remove that saved job.");
    }
  };
  return (
    <div className="jobs-page">
      ...
      <main className="jobs-main jobs-library">
        <header className="jobs-page-heading">
          ...
          <h1>Saved jobs</h1>
          <p>
            Keep promising roles together and move from discovery to focused
            preparation.
          </p>
        </header>
        {error && <p className="jobs-notice jobs-notice--error">{error}</p>}
        {loading ? (
          ...
          <div className="jobs-state">
            ...
            <p>Save jobs while searching and they’ll appear here.</p>
