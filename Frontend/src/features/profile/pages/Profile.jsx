...
const Profile = () => {
  ...
  const save = async (event) => {
    ...
    try {
      ...
      setError(
        requestError.response?.data?.message || "Profile could not be updated.",
      );
    } finally {
      setSaving(false);
    }
    ...
    <div className="profile-page">
      ...
      <main className="profile-main">
        <header className="profile-heading">
          <p>Your account</p>
          <h1>Profile</h1>
          <span>Manage how you appear across InterviewForge.</span>
        </header>
          ...
          <>
            ...
            >
              <div className="profile-section-heading">
                <p>Practice statistics</p>
                <h2 id="profile-stats-title">Your preparation activity</h2>
              </div>
              <div>
                <article>
                  <span>Technical sessions</span>
                  <strong>{progress?.focusedPracticeCompleted ?? "—"}</strong>
                </article>
                <article>
                ...
                <article>
                  <span>MCQ tests</span>
                  <strong>{progress?.mcq?.completed ?? "—"}</strong>
                </article>
              </div>
            </section>
            ...
            <section className="profile-security">
              <div>
                ...
                <span>Sign out of InterviewForge on this device.</span>
              </div>
              ...
              <div className="avatar-options">
                {AVATAR_OPTIONS.map((option) => (
                  <button
                    ...
                    type="button"
                    className={
                      avatarStyle === option.style ? "is-selected" : ""
                    }
                    aria-pressed={avatarStyle === option.style}
