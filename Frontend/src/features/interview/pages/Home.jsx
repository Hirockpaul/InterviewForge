  ...
  return (
    <div className="home-page">
      ...
      <header className="page-header">
        ...
        <p>
          Let AI turn your target role and experience into a focused strategy
          built around you.
        </p>
      </header>
      ...
      <section className="recent-reports">
        ...
        {reports.length > 0 ? (
              ...
              <li key={report._id}>
                ...
                >
                  ...
                  <span className="report-link">
                    View interview plan <span aria-hidden="true">&rarr;</span>
                  </span>
                </button>
              </li>
            ))}
          ...
          <div className="reports-empty">
            ...
            <p>
              Your personalized strategies will appear here after you generate
              your first plan.
            </p>
            <button
              type="button"
