...
const CodingTopic = () => {
  ...
  useEffect(() => {
    getCodingTopics()
      .then((data) =>
        setTopic(data.topics.find((item) => item.slug === topicSlug) || false),
      )
      .catch(() => setTopic(false));
  }, [topicSlug]);
      ...
      <div className="coding-page">
        ...
        <main className="coding-practice-main">
          <div className="coding-notice coding-notice--error">
            Coding topic not found.{" "}
            <Link to="/coding-practice">Browse topics</Link>
          </div>
        </main>
      </div>
    );
    ...
    <div className="coding-page">
      ...
      <main className="coding-practice-main">
        <header className="coding-topic-heading">
          ...
          {topic && (
            <div className="coding-topic-counts">
              <span>Easy: {topic.counts.easy}</span>
              <span>Medium: {topic.counts.medium}</span>
              <span>Hard: {topic.counts.hard}</span>
            </div>
          )}
        </header>
        ...
        {isLoading ? (
          <div className="coding-notice">Loading problems...</div>
        ) : problems.length > 0 ? (
          ...
          <div className="coding-empty">
            <h2>
              ...
              {topic?.displayName} problems available yet.
            </h2>
            <p>
              Ask the AI problem designer to prepare a focused set for this
              topic.
            </p>
