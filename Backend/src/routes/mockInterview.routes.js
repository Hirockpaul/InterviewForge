...
mockInterviewRouter.get(
  ...
  controller.listMockInterviewsController,
);
mockInterviewRouter.post(
  "/",
  authMiddleware.authUser,
  aiLimiter,
  controller.startMockInterviewController,
);
mockInterviewRouter.get(
  "/:mockInterviewId",
  authMiddleware.authUser,
  controller.getMockInterviewController,
);
mockInterviewRouter.post(
  "/:mockInterviewId/answer",
  authMiddleware.authUser,
  aiLimiter,
  controller.answerMockInterviewController,
);
