...
const jobAnalysisSchema = new mongoose.Schema({
    ...
    strengths: [String], skillGaps: [String], requiredSkills: [String], niceToHave: [String],
    interviewTopics: [String], difficulty: { type: Number, min: 1, max: 10 }, likelyRounds: [String],
